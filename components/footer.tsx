    ...
    >
      <div className="container mx-auto px-4">
        ...
        <motion.div variants={itemVariants}>
          <Card className="max-w-2xl mx-auto mb-12 bg-white border-none shadow-xl rounded-xl">
            <CardHeader className="rounded-t-xl">
              <CardTitle className="text-2xl text-center font-semibold text-green-600 rounded-t-xl">
        ...
        >
          ...
          <div className="flex flex-row space-x-10 justify-center items-center">
            <p>Privacy Policy</p> <Linkedin height={20} />
          </div>
